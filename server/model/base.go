...
type BaseModel struct {
	...
	CreatedAt carbon.Carbon  `gorm:"column:created_at;index:idx_created_at;comment:创建时间" json:"created_at"`
	UpdatedAt carbon.Carbon  `gorm:"column:updated_at;index:idx_updated_at;comment:更新时间" json:"updated_at"`
